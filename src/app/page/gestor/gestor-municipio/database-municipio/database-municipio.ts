...
/**
 * Componente DatabaseComponent
 * Vista de acceso rápido a la gestión de las tablas maestras del sistema, con filtrado por rol.
 */

@Component({
  selector: 'app-database-municipio',
  imports: [
    CommonModule,
    RouterOutlet
  ],
  templateUrl: './database-municipio.html',
  styleUrl: './database-municipio.css',
})
export class DatabaseMunicipio implements OnInit {
