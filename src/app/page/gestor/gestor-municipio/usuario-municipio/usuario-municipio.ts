...
@Component({
  selector: 'app-usuario-municipio',
  imports: [CommonModule],
  templateUrl: './usuario-municipio.html',
  styleUrl: './usuario-municipio.css',
})
export class UsuarioMunicipio implements OnInit, OnDestroy {
  usuarios: Usuario[] = [];
  pendingUsuarios: Usuario[] = [];
  isLoading = false;

  errorMessage: string | null = null;
  approvalMessage: string | null = null;
  approvalMessageType: 'success' | 'danger' | 'warning' | null = null;
  ...
  currentUserCircuitoId: number | null = null;
